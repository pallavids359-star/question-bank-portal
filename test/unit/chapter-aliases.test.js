...
const displayCases = [
  ...
  ['Maths', '12', '3D Geomerty', 'Three Dimensional Geometry'],
  ['Mathematics', '12', 'Application of Derivative', 'Application of Derivatives'],
  ['Mathematics', '12', 'Algebra of Derivatives', 'Application of Derivatives'],
  ['Mathematics', '12', 'Derivative as Rate Measure', 'Application of Derivatives'],
  ['Mathematics', '12', 'Geometrical Interpretation of a Derivative', 'Application of Derivatives'],
  ['Mathematics', '12', 'area', 'Application of Integrals'],
  ['Mathematics', '12', 'Definite Integration', 'Integrals'],
  ['Mathematics', '12', 'Fundamental Theorem of Definite Integration', 'Integrals'],
  ['Mathematics', '12', 'Definite Integration of Odd-Even and Periodic Functions', 'Integrals'],
  ['Mathematics', '12', 'Exponential and Logarithmic Functions', 'Continuity and Differentiability'],
  ['Mathematics', '12', 'Vectors', 'Vector Algebra'],
