...
function isCloudinaryMigratedShard(subject, klass) {
    ...
    try {
      ...
      if (!isCloudinaryMigratedShard(subject, klass)) {
        return res.status(400).json({
          error: 'Cloudinary image upload is currently enabled only for Physics, Chemistry, Biology and Mathematics Classes 11 and 12.',
        });
      }
